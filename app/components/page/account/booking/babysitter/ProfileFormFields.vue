<template>
  <div class="space-y-10">
    <div class="grid md:grid-cols-2 gap-6">
      <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ t('account.nannyForm.firstName') }}</label>
        <UInput v-model="form.firstName" type="text" :placeholder="t('account.nannyForm.firstName')" size="lg" />
      </div>
      <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ t('account.nannyForm.lastName') }}</label>
    ...
    <div class="grid md:grid-cols-2 gap-6">
      <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ t('account.nannyForm.birthDate') }}</label>
        <UInput v-model="form.birthDate" type="date" size="lg" />
      </div>
      <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ t('account.nannyForm.experience') }}</label>
        <UInput v-model="form.experience" type="number" min="0" :placeholder="t('account.nannyForm.experiencePlaceholder')" size="lg" />
      </div>
    </div>

    <div>
      <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ t('account.nannyForm.about') }}</label>
      <textarea
          v-model="form.bio"
          rows="4"
    ...
    <div class="grid md:grid-cols-2 gap-6">
      <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ t('account.nannyForm.minOrder') }}</label>
        <UInput v-model="form.minOrderAmount" type="text" :placeholder="t('account.nannyForm.minOrderPlaceholder')" size="lg" />
      </div>
      <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ t('account.nannyForm.cancellationPolicy') }}</label>
        <UInput v-model="form.cancellationPolicy" type="text" :placeholder="t('account.nannyForm.cancellationPolicyPlaceholder')" size="lg" />
      </div>
      <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ t('account.nannyForm.onlineLesson') }}</label>
        <UInput v-model="form.onlineLesson" type="text" :placeholder="t('account.nannyForm.onlineLessonPlaceholder')" size="lg" />
      </div>
      <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ t('account.nannyForm.petAttitude') }}</label>
        <UInput v-model="form.petAttitude" type="text" :placeholder="t('account.nannyForm.petAttitudePlaceholder')" size="lg" />
      </div>
    </div>
    ...
    <div class="grid md:grid-cols-2 gap-6">
      <div>
        <div class="flex items-center gap-3 mb-3">
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('account.nannyForm.certificates') }}</label>
          <UInput
          ...
          />
          <UButton variant="ghost" size="sm" @click="emit('add-certification')">{{ t('account.nannyForm.add') }}</UButton>
        </div>
        <div class="flex flex-wrap gap-2">
          ...
          <span v-if="!form.certifications?.length" class="text-sm text-gray-500 dark:text-gray-400">{{ t('account.nannyForm.certificatesEmpty') }}</span>
        </div>
      </div>

      <div>
        <div class="flex items-center gap-3 mb-3">
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('account.nannyForm.advantages') }}</label>
          <UInput
        ...
        <div class="flex flex-wrap gap-2">
          ...
          <span v-if="!form.advantages?.length" class="text-sm text-gray-500 dark:text-gray-400">{{ t('account.nannyForm.advantagesEmpty') }}</span>
        </div>
      </div>
    </div>
  </div>
