      ...
      <div class="max-w-4xl mx-auto">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8">
          <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-6">
            Как найти бебиситтера в Батуми
          </h1>

          <div class="prose prose-gray dark:prose-invert max-w-none">
            <section class="mb-8">
              <p class="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed text-lg">
                Ищете надёжного бебиситтера в Батуми? Наша платформа поможет вам найти проверенного специалиста для ухода за вашими детьми. Все бебиситтеры проходят верификацию и имеют опыт работы с детьми.
              </p>
            </section>
                ...
                <div class="flex gap-4">
                  ...
                  <div>
                    ...
                    <p class="text-gray-700 dark:text-gray-300">
                      Перейдите в раздел поиска и укажите город Батуми. Вы сможете увидеть всех доступных бебиситтеров в вашем городе.
                    </p>
                  </div>
                </div>
                <div class="flex gap-4">
            ...
            <section class="mb-8">
              <div class="bg-primary-50 dark:bg-primary-900/20 rounded-lg p-6 text-center">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">
                  Готовы найти бебиситтера в Батуми?
                </h3>
                <UButton to="/search?city=batumi" color="primary" size="lg">
                  Найти бебиситтера
                </UButton>
              </div>
            </section>
...
useSeoMeta({
  title: 'Как найти бебиситтера в Батуми',
  description: 'Ищете надёжного бебиситтера в Батуми? Наша платформа поможет найти проверенного специалиста для ухода за детьми.',
  ogTitle: 'Как найти бебиситтера в Батуми',
  ogDescription: 'Ищете надёжного бебиситтера в Батуми? Наша платформа поможет найти проверенного специалиста для ухода за детьми.',
  ogImage: `${siteConfig.url}${siteConfig.logo}`,
  ogUrl: currentUrl,
  ogType: 'website',
  ogLocale: locale.value,
  twitterCard: 'summary_large_image',
  twitterTitle: 'Как найти бебиситтера в Батуми',
  twitterDescription: 'Ищете надёжного бебиситтера в Батуми? Наша платформа поможет найти проверенного специалиста для ухода за детьми.',
