      ...
      <div class="max-w-4xl mx-auto">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8">
          <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-6">
            {{ $t('pages.findBabysitter.batumi.title') }}
          </h1>

          <div class="prose prose-gray dark:prose-invert max-w-none">
            <section class="mb-8">
              <p class="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed text-lg">
                {{ $t('pages.findBabysitter.batumi.intro') }}
              </p>
            </section>

            <section class="mb-8">
              <h2 class="text-2xl font-semibold text-gray-900 dark:text-white mb-4">
                {{ $t('pages.findBabysitter.batumi.stepsTitle') }}
              </h2>
              <div class="space-y-6">
                <div class="flex gap-4">
                  ...
                  <div>
                    <h3 class="font-semibold text-gray-900 dark:text-white mb-1">
                      {{ $t('pages.findBabysitter.batumi.steps.step1.name') }}
                    </h3>
                    <p class="text-gray-700 dark:text-gray-300">
                      {{ $t('pages.findBabysitter.batumi.steps.step1.text') }}
                    </p>
                  </div>
                </div>
                <div class="flex gap-4">
                  ...
                  <div>
                    <h3 class="font-semibold text-gray-900 dark:text-white mb-1">
                      {{ $t('pages.findBabysitter.batumi.steps.step2.name') }}
                    </h3>
                    <p class="text-gray-700 dark:text-gray-300">
                      {{ $t('pages.findBabysitter.batumi.steps.step2.text') }}
                    </p>
                  </div>
                </div>
                <div class="flex gap-4">
                  ...
                  <div>
                    <h3 class="font-semibold text-gray-900 dark:text-white mb-1">
                      {{ $t('pages.findBabysitter.batumi.steps.step3.name') }}
                    </h3>
                    <p class="text-gray-700 dark:text-gray-300">
                      {{ $t('pages.findBabysitter.batumi.steps.step3.text') }}
                    </p>
                  </div>
                </div>
                <div class="flex gap-4">
                  ...
                  <div>
                    <h3 class="font-semibold text-gray-900 dark:text-white mb-1">
                      {{ $t('pages.findBabysitter.batumi.steps.step4.name') }}
                    </h3>
                    <p class="text-gray-700 dark:text-gray-300">
                      {{ $t('pages.findBabysitter.batumi.steps.step4.text') }}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section class="mb-8">
              <div class="bg-primary-50 dark:bg-primary-900/20 rounded-lg p-6 text-center">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">
                  {{ $t('pages.findBabysitter.batumi.ctaTitle') }}
                </h3>
                <UButton to="/search?city=batumi" color="primary" size="lg">
                  {{ $t('pages.findBabysitter.batumi.ctaButton') }}
                </UButton>
              </div>
            </section>
          </div>
